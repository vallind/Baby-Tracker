...
fun AppChatInputBar(
    ...
    Row(
        modifier
            .fillMaxWidth()
            .background(ChatInputBarDefaults.containerColor())
            .padding(
                horizontal = ChatInputBarDefaults.horizontalPadding(),
                vertical = ChatInputBarDefaults.verticalPadding(),
            ),
        ...
        Spacer(Modifier.width(ChatInputBarDefaults.fieldActionGap()))
        AppButton(
