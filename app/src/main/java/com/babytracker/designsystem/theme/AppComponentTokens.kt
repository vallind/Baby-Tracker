...
data class InputTokens(
    ...
    companion object {
        fun default(
            ...
            fontSize = typography.bodyLarge.fontSize,
            fontSizeSmall = typography.bodyMedium.fontSize,
            fontSizeLarge = typography.titleMedium.fontSize,
            borderWidth = 0.dp,
            borderWidthFocus = 2.dp,
            iconSize = control.medium.iconSize,
            iconSizeSmall = control.small.iconSize,
            iconSizeLarge = control.large.iconSize,
