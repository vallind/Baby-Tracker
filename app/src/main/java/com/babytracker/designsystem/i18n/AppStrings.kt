...
object AppStrings {
    ...
    const val aiAnalysisSleepRange = "最近 7 天"
    const val aiAnalysisFeedingRange = "最近 3 天"
    const val aiAnalysisHealthRange = "最近 30 天"
    const val aiAnalysisOverviewRange = "多类近期记录"
